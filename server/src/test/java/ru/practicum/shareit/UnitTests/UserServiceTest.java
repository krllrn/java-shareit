...
public class UserServiceTest {
    ...
    private User user = new User(1L, "test1", "test1@email.com");
    private User user2 = new User(2L, "test2", "test2@email.com");
    private UserDto userDto = new UserDto(1L, "test1", "test1@email.com");
