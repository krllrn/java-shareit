...
public class BookingControllerTest {
    ...
    private ItemShort itemShort = new ItemShort(1L);
    private BookingDto bookingDto = new BookingDto(itemShort, LocalDateTime.now(), LocalDateTime.now().plusDays(1));

    private BookingDto bookingDto2 = new BookingDto(new ItemShort(1L), LocalDateTime.now(), LocalDateTime.now().plusDays(1));
