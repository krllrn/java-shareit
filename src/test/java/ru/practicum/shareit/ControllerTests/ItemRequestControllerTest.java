...
public class ItemRequestControllerTest {
    ...
    private ItemRequestDto itemRequestDto = new ItemRequestDto("Test item request");

    private ItemRequestDto itemRequestDto2 = new ItemRequestDto("Test2 item request");
